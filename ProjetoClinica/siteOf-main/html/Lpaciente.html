...
<head>
    ...
    <link rel="stylesheet" href="../css/Lpaciente.css">
    <style>
      @font-face {
...
<a href="loginG.html"><div id="voltar">
            <p>voltar</p>
        </div></a>
...
<body style="overflow-x: hidden;">
    <div id="bola1">
        <h5>CPF:</h5>
        <h5 style="top: 250px;">Senha:</h5>
    </div>
        
    <a href="esquecisenha.html">
        <h3>
            Esqueceu a senha? Trocar a senha pelo E-MAIL
        </h3>
    </a>
       <h4>Nome completo:</h4>
       <input id="i1" type="text" >
       <input id="i2" type="text" placeholder="Apenas números">
