...
class CmedicoController {
    ...
    public function saveMedico() {
        ...
        if ($medico->cadastrar()) {
            ...
            header('Location: /Projeto_SP_Medical_Group_Final/siteOf-main/Cpaciente/homeM');
        } else {
    ...
    public function homeMedicos() {

        // Exibe a lista de pacientes (implemente a view correspondente)
    require_once '../views/html/homeMedico.html'; // Crie essa view para listar os pacientes
}
}